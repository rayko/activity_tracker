module ApplicationHelper
  ...
  def regular_red_btn_class
    "block text-center mx-2 rounded-md bg-linear-to-t from-red-700 to-red-400 text-gray-200 font-bold outline-red-300 px-3 py-1 hover:outline-2 hover:outline-red-500 text-shadow-md/30"
  end
